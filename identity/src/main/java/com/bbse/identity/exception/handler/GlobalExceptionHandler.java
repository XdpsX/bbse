...
import com.bbse.identity.dto.ErrorDetailsDTO;
...
public class GlobalExceptionHandler extends AbstractExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleBadCredentials(BadCredentialsException e, HttpServletRequest request){
        HttpStatus status = HttpStatus.UNAUTHORIZED;
        String message = e.getMessage();

        return buildErrorResponse(status, message, e, request);
    }
